public class Date {
	...
	private void setDay(int day) {
		if (day < 1 || day > 31) { //*Refactoring* Combined two separate if statements to formulate one more concrete if statement
			throw new IllegalArgumentException("Illegal Day Input");
		}
		if (isThirtyDayMonth() && day > 30 || this.month == 2 && isLeapYear() && day > 29 || this.month == 2 && !isLeapYear() && day > 28) { //*Refactoring* Combined multiple if statements to form one more concrete if statement
