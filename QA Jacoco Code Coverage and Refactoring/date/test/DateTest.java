...
class DateTest {
  ...
  @Test //Test added. Testing leap year functionality further.
  void nextDate_tc16() {
  ...
  @Test //Test added. Testing illegal boundary values.
  ...
  @Test //Test added. Further testing boundaries such that illegal arguments are not thrown on working boundary values.
  void nextDate_tc24() {
    Date today = new Date(0, 12, 31);
    Date expectedTomorrow = new Date(1, 1, 1);
    assertEquals(expectedTomorrow, today.nextDate());
  }
  @Test //test added. Testing legal boundary values.
  void nextDate_tc25() {
